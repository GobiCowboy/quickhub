...
struct ShellCommandSettingsView: View {
    ...
    private let presetCategories: [(name: String, icon: String, items: [ShellPreset])] = [
        (
            ...
            icon: "terminal",
            items: [
                ShellPreset(name: "shell.file_info", command: InternalShellCommand.fileInfo, icon: "openmoji/file_info.png", openTerminal: false),
                ShellPreset(name: "shell.copy_path", command: "echo -n '{path}' | pbcopy", icon: "openmoji/copy_path.png", openTerminal: false),
                ShellPreset(name: "shell.open_in_terminal", command: "open -b com.apple.Terminal '{dir}'", icon: "openmoji/terminal.png", openTerminal: false),
                ShellPreset(name: "shell.open_in_iterm", command: "open -b com.googlecode.iterm2 '{dir}'", icon: "openmoji/terminal.png", openTerminal: false),
                ShellPreset(name: "shell.open_in_vscode", command: "open -b com.microsoft.VSCode '{dir}'", icon: "openmoji/terminal.png", openTerminal: false),
                ShellPreset(name: "shell.open_in_atom", command: "open -b com.github.atom '{dir}'", icon: "openmoji/terminal.png", openTerminal: false),
            ]
        ),
        (
            ...
            items: [
                ShellPreset(name: "shell.create_shortcut_desktop", command: "ln -s '{path}' ~/Desktop/", icon: "openmoji/shortcut.png", openTerminal: false),
                ShellPreset(name: "shell.compress_zip", command: "ditto -c -k --sequesterRsrc '{path}' \"$(dirname '{path}')/{filename}.zip\"", icon: "openmoji/compress.png", openTerminal: false),
                ShellPreset(name: "shell.view_icon", command: "osascript -e 'tell application \"Finder\" to activate' -e 'delay 0.1' -e 'tell application \"Finder\" to set current view of front Finder window to icon view'", icon: "openmoji/view_grid.png", openTerminal: false),
                ShellPreset(name: "shell.view_list", command: "osascript -e 'tell application \"Finder\" to activate' -e 'delay 0.1' -e 'tell application \"Finder\" to set current view of front Finder window to list view'", icon: "openmoji/view_list.png", openTerminal: false),
                ShellPreset(name: "shell.view_column", command: "osascript -e 'tell application \"Finder\" to activate' -e 'delay 0.1' -e 'tell application \"Finder\" to set current view of front Finder window to column view'", icon: "openmoji/view_column.png", openTerminal: false),
                ShellPreset(name: "shell.view_gallery", command: "osascript -e 'tell application \"Finder\" to activate' -e 'delay 0.1' -e 'tell application \"Finder\" to set current view of front Finder window to flow view'", icon: "openmoji/view_gallery.png", openTerminal: false),
            ]
        ),
        (
            ...
            items: [
                ShellPreset(name: "shell.open_in_vscode", command: "open -b com.microsoft.VSCode '{dir}'", icon: "openmoji/terminal.png", openTerminal: false),
                ShellPreset(name: "shell.git_status", command: "cd '{dir}' && git status", icon: "openmoji/git_status.png", openTerminal: true),
                ShellPreset(name: "shell.git_add", command: "cd '{dir}' && git add '{filename}'", icon: "openmoji/git_add.png", openTerminal: true),
                ShellPreset(name: "shell.git_diff", command: "cd '{dir}' && git diff '{filename}'", icon: "openmoji/git_diff.png", openTerminal: true),
                ShellPreset(name: "shell.git_log", command: "cd '{dir}' && git log --oneline -20", icon: "openmoji/git_log.png", openTerminal: true),
            ]
        ),
    ]

    private let commandPresets: [CommandPreset] = [
        CommandPreset(name: "command.cut_file", icon: "openmoji/cut.png", type: .cutFile),
        CommandPreset(name: "command.copy_file", icon: "openmoji/copy_file.png", type: .copyFile),
        CommandPreset(name: "command.paste_file", icon: "openmoji/paste.png", type: .pasteFile),
        CommandPreset(name: "command.move_to_trash", icon: "openmoji/trash.png", type: .moveToTrash),
        CommandPreset(name: "command.rename", icon: "openmoji/rename.png", type: .rename),
        CommandPreset(name: "command.open_with", icon: "openmoji/open_with.png", type: .openWith),
        CommandPreset(name: "command.share_file", icon: "openmoji/share.png", type: .shareFile),
    ]
